...
_TRANSLATIONS: Dict[Language, Dict[str, str]] = {
    Language.UKRAINIAN: {
        ...
        "message.not_enough_quantity_detail": "Запитано: {requested}, Доступно: {available}",
        ...
        "location.required.title": "Місцезнаходження обов'язкове",
        "location.required.message": "Для роботи програми потрібно створити хоча б одне місце зберігання. Завершити роботу?",
        # Transfer
    ...
    Language.ENGLISH: {
        ...
        "message.not_enough_quantity_detail": "Requested: {requested}, Available: {available}",
        ...
        "location.required.title": "Location Required",
        "location.required.message": "A storage location is required to use this application. Do you want to exit?",
        # Transfer
