...
![Діалог першого запуску](img/first-launch.png)
...
![Форма додавання товару](img/add-item.png)
...
![Пошук та фільтр за локацією](img/search.png)
...
![Діалог переміщення товару](img/transfer.png)
...
![Всі транзакції](img/transactions.png)
...
![Параметри експорту](img/export.png)
